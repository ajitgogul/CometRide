...
def main():
    ...
    '''
    colunm_names = 'RouteID VehicleID CurrentRiders PrevLat PrevLong TotalRiders VehicleLat VehicleLong VehicleTotalCapacity'.split()
    table_name = 'LiveVehicleInformation'
    csv_file_name = 'driverinfo_2.csv'
    column_types = [str, int, int, float, float, int, float, float, int]
