...
def main():
    ...
    '''
    colunm_names = 'RouteID ShiftStartTime DriverID ShiftEndTime TotalRiders'.split()
    table_name = 'ShiftInformation'
    csv_file_name = 'shiftinfo1.csv'
    column_types = [str, str, str, str, int]
